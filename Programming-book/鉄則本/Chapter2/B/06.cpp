...
int main() {
    ...
    rep(i, 0, Q) {
        ...
        if (win[R] - win[L - 1] == lose[R] - lose[L - 1]) cout << "draw" << endl;
        else if (win[R] - win[L - 1] > lose[R] - lose[L - 1]) cout << "win" << endl;
        else if (win[R] - win[L - 1] < lose[R] - lose[L - 1]) cout << "lose" << endl;
    }
}