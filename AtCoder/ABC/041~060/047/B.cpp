...
int main() {
    ...
    rep(i, 0, N) {
        ...
        if (a == 1) rep(dy, 0, H) rep(dx, 0, x) field[dy][dx] = 1;
        if (a == 2) rep(dy, 0, H) rep(dx, x, W) field[dy][dx] = 1;
        if (a == 3) rep(dy, 0, y) rep(dx, 0, W) field[dy][dx] = 1;
        if (a == 4) rep(dy, y, H) rep(dx, 0, W) field[dy][dx] = 1;
    }
